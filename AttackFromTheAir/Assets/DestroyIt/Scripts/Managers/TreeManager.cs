    ...
    public class TreeManager : MonoBehaviour
    {
        ...
        private void Start()
        {
            ...
            for (int i = 0; i < treeInstances.Length; i++)
            {
                ...
                GameObject treeObj = Instantiate(destructibleTree.Prefab);
                treeObj.transform.parent = terrain.transform.parent;
            ...
            for (int i = 0; i < terrain.terrainData.treePrototypes.Length; i++)
            {
                ...
                foreach (Component comp in treeObj.GetComponentsInChildren<Component>())
                {
                    if (comp.GetType() != typeof(Transform) && comp.GetType() != typeof(CapsuleCollider) && comp.GetType() != typeof(BoxCollider) && 
                        ...
                        comp.GetType() != typeof(HitEffects) && comp.GetType() != typeof(TagIt) && comp.GetType() != typeof(ParticleSystem) && comp.GetType() != typeof(ParticleSystemRenderer))
