            ...
            EditorGUILayout.Separator();
                ...
                if (destructible.useFallbackParticle)
                {
                    ...
                    if (destructible.fallbackParticle == null)
                    {
                        EditorGUILayout.BeginHorizontal();
                        EditorGUILayout.LabelField("", GUILayout.Width(15));
                        GUIContent fallbackParticleMaterialContent = new GUIContent("Material:", "Here you can specify the material that will be used for the fallback particle effect. Leave blank to use the first material (index 0) on the Destructible object's mesh.");
                        EditorGUILayout.LabelField(fallbackParticleMaterialContent, GUILayout.Width(55));
