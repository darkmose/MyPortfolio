...
namespace Core.CameraLogic
{
    public class PlayerServicesInstaller : MonoInstaller
    {
        public override void InstallBindings()
        {
            ...
            Container.Bind<IPlayerExpirienceService>().To<PlayerExpirienceService>().AsSingle();
            Container.Bind<IWeaponDecoratorsHolder>().To<WeaponDecoratorsDataHolder>().AsSingle();
        }
    }
}